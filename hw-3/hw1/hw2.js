...
let numberPrompt = +prompt("Tell me number please");

if (numbers.includes(numberPrompt)) {
  var index = numbers.indexOf(numberPrompt);
  numbers.splice(numbers[index], 0, numberPrompt);
} else {
